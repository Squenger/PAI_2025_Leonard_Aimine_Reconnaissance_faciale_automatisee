...
if os.environ.get("FACIAL_RECOGNITION_COMPILE_MYPYC") == "1":
...
def get_ext_modules():
    ...
    If the `FACIAL_RECOGNITION_COMPILE_MYPYC` environment variable is set to "1",
    ...
    if os.environ.get("FACIAL_RECOGNITION_COMPILE_MYPYC") == "1":
        ...
        # For example:
        # return mypycify([
        #     "src/facial_recognition/__main__.py",
        #     "src/facial_recognition/some_other_module.py",
        # ])
        return mypycify(
            [
                "src/facial_recognition/__main__.py",
